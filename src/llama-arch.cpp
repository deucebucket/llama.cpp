...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_QWEN2_BRAINLOOP,  "qwen2-brainloop"  },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_BRAINLOOP_ATTN_Q,                       "blk.%d.brainloop_attn_q" },
    { LLM_TENSOR_BRAINLOOP_ATTN_K,                       "blk.%d.brainloop_attn_k" },
    { LLM_TENSOR_BRAINLOOP_ATTN_V,                       "blk.%d.brainloop_attn_v" },
    { LLM_TENSOR_BRAINLOOP_ATTN_OUT,                     "blk.%d.brainloop_attn_output" },
    { LLM_TENSOR_BRAINLOOP_FFN_GATE,                     "blk.%d.brainloop_ffn_gate" },
    { LLM_TENSOR_BRAINLOOP_FFN_UP,                       "blk.%d.brainloop_ffn_up" },
    { LLM_TENSOR_BRAINLOOP_FFN_DOWN,                     "blk.%d.brainloop_ffn_down" },
    { LLM_TENSOR_BRAINLOOP_LN1,                          "blk.%d.brainloop_ln1" },
    { LLM_TENSOR_BRAINLOOP_GATE,                         "blk.%d.brainloop_gate" },
};
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // Brainloop refiner
    {LLM_TENSOR_BRAINLOOP_ATTN_Q,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_ATTN_K,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_ATTN_V,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_ATTN_OUT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_FFN_GATE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_FFN_UP,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_FFN_DOWN,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BRAINLOOP_LN1,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_BRAINLOOP_GATE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    // Nemotron 3 Super
