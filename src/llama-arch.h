...
enum llm_tensor {
    ...
    // Brainloop refiner tensors (layer-repeating, at split layer only)
    LLM_TENSOR_BRAINLOOP_ATTN_Q,
    LLM_TENSOR_BRAINLOOP_ATTN_K,
    LLM_TENSOR_BRAINLOOP_ATTN_V,
    LLM_TENSOR_BRAINLOOP_ATTN_OUT,
    LLM_TENSOR_BRAINLOOP_FFN_GATE,
    LLM_TENSOR_BRAINLOOP_FFN_UP,
    LLM_TENSOR_BRAINLOOP_FFN_DOWN,
    LLM_TENSOR_BRAINLOOP_LN1,
    LLM_TENSOR_BRAINLOOP_GATE,
};
